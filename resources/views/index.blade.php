        ...
        <div class="container-fluid">
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_4.png')}}" data-lightbox="image-1"><div class="thumb">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_4.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_2.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_2.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_3.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_3.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_1.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_1.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_5.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_5.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_6.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_6.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_7.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_7.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    <a href="{{asset('template/img/big_portfolio_item_8.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_8.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
            	<div class="portfolio-item">
                	<a href="{{asset('template/img/big_portfolio_item_9.png')}}" data-lightbox="image-1"><div class="thumb">
                        <div class="hover-effect">
                            <div class="hover-content">
                        ...
                        <div class="image">
                            <img src="{{asset('template/img/portfolio_item_9.png')}}">
                        </div>
                    </div></a>
                </div>
            </div>
